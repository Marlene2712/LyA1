def AbrirArchivoTxt():
    ...
    codigoJava = open(r"C:\Users\Marlene\Documents\sexto semestre\LyA1\Proyecto final de Automatas\java.txt",'r')#abre el archivo .txt y lo guarda en la variable
...
def Traductor(listaDeLineas):
    ...
    for i in listaDeLineas:
        linea = i
        linea = linea.replace('public static void main(String[] args) {', '')#Remplazara los textos anteriores por los nuevos 
